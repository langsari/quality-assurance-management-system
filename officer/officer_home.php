        ...
        <fieldset>
            <form>
                ...
                <nav class="top-bar" data-topbar>
                    <ul class="title-area">
                        <li class="name">
                            <h1><a href="#">QUALITY ASSURANCE</a></h1>
                        </li>
                    </ul>
                    ...
                    <div class="row">
                        <div class="small-3 columns">
                            ...
                            <fieldset>
                                ...
                                <a href="#" class="link round button font" data-dropdown="drop1">PROFILE &raquo;</a>
                                <ul id="drop1" class=" small content f-dropdown" data-dropdown-content>
                                    <li><a href="Profile.php">Home</a></li>
                                    <li><a href="profile_edit.php">Update</a></li>
                                </ul>

                                <a href="#" class="link round button font" data-dropdown="drop2">PROJECT  &raquo;</a>
